...
axios.defaults.baseURL = "https://backend.ajmalkhan.online/";
// axios.defaults.baseURL = "https://ajmalkhan.online/api/";
...
axios.interceptors.response.use(
  ...
  function (error) {
    ...
    if (
      ...
      error.config.url === "api/token/refresh/" //   core/refresh/token/
    ) {
